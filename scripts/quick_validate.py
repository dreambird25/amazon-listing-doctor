...
REQUIRED = (
    ...
    ".agents/skills/amazon-listing-doctor/scripts/quality_contract.py",
    ".agents/skills/amazon-listing-doctor/scripts/quality_policy.py",
...
def validate_skill() -> None:
    ...
    if not re.search(r"(?m)^\s+version:\s+1\.5\.1\s*$", frontmatter):
        fail("SKILL.md version is not 1.5.1")
